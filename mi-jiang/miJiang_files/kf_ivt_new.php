	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www5c1.53kf.com/webCompany.php?kf_sign=jYyNDMTU4MY0NzExMjQ2MjE3MDkwMDAyNzIxMzI4Njk=&arg=10132869&style=1&kflist=off&kf=001%2C004%2C003%2C005%2Clexiwed_007%40163.com%2C3475870%40qq.com%2C2657853251%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fm.mijwed.com%2Fsem-sem20191112&keyword=&brief=&logo=&question=&uid=266f6068a297a9240f9d7e10540181d3";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	var create_flp_jquery_timer = window.setInterval(function(){
		if (!document.getElementById('hz6d_flp_jquery')) {
			$53.creElm({
				id: 'hz6d_flp_jquery',
				src: 'https://www5c1.53kf.com/minkh/js/jquery-1.4.2.flp.js?20121127002',
				charset: "utf-8",
	...
	function hz6d_re_flashing(cid) {
		...
		// 邀请框处理
		var acc_pop_page		 = "0";
		var acc_pop_pagenum	= 1000;
		var acc_pop_total		= "0";
		var acc_pop_totalnum = 1000;
		...
		var ivt_autotype			= "0";
		var zdyivt					= "0";
		var ivtstr					= "<div id=\"inv_box_53kf\" style=\"width: 380px; padding-top: 10px; padding-left: 10px; box-sizing: border-box; position: fixed; left:12px; top:86px;display: block;z-index:999998;\"><div style=\"position:absolute;left:0;top:0;width:20px;height:20px;cursor:pointer;z-index:5;\" onclick = \"inv.clos()\"><img style=\"width:100%;height:100%;\" src=\"https://www5c1.53kf.com/style/setting/ver07/img/style_mobile_invite/close_2x.png\"></div><div class=\"inv_bg_color\" style=\"width:100%;padding:24px 16px;box-sizing: border-box;overflow:hidden;background:#FFFFFF;border: 1px solid rgba(0,0,0,0.10); border:1px solid #eee; box-shadow:rgba(74, 144, 226, 0.4) 0px 0px 10px 0px;border-radius: 2px;\"><div class=\"inv_title\" style=\"font-size:22px;text-align:center;float:left;width:100%;line-height:32px;margin-bottom:8px;letter-spacing:1px;box-sizing:border-box;color:#3A3C4C;\">蜜匠婚礼 备婚清单</div><div class=\"inv_content\" style=\"font-size: 14px; line-height: 20px;  text-align: left; max-height: 60px; overflow: auto; float: left; width: 100%; margin-bottom: 16px; word-wrap: break-word; color: #3A3C4C;\">蜜匠婚礼~史上最全备婚清单，千万新娘经验总结~可在线领取或者点击电话咨询，顾问一对一详细介绍哟</div><div style=\"position: relative; float:left;width: 100%;height: 32px;line-height: 32px;font-size: 14px;margin-bottom: 24px;\"><p id=\"wrong_form_53kf\" style=\"margin:0;height:20px; line-height:20px; position:absolute; z-index: 9;left: 0; top:-22px; padding: 0 4px; display: none; background: #F44024;color:#FFF;box-sizing: border-box;\">请输入正确的号码</p><p id=\"right_form_53kf\" style=\"margin:0;height:20px; line-height:20px; position:absolute; z-index: 9;left: 0; top:-22px; padding: 0 4px; display: none; background: #57AD68;color:#FFF;box-sizing: border-box;\">请留意电话接听</p><input id=\"phoneNum_53kf\" class=\"phone_num\" placeholder=\"输入手机号码\" type=\"text\" onfocus=\"inv.focu()\" onkeyup=\"inv.justNum()\" data-color=\"#ff0015\" style=\"position: initial; text-align: left;box-sizing: border-box; outline: medium;width: 237px;height: 100%;background: #FFFFFF;padding-left:5px;border-radius: 2px 0 0 2px;float: left;border: 2px solid #ff0015;\"><span id=\"inv_btn_53kf\" class=\"inv_btn\" style=\"float: left;height: 100%;width: 98px;text-align:center;border-radius : 0 2px 2px 0;cursor: pointer;color:#FFF;background:#ff0015;\" onclick = \"inv.makePhone()\">点击免费通话</span><span id=\"alpha20_53kf\" style=\"display: none; position: absolute;right: 0;top: 0;height: 32px;background: #FFF;width: 100px;opacity: 0.2;filter: alpha(opacity=20)\"></span></div><div class=\"talk_btn\" style=\"float:left;width:100%;border-radius:2px;height:44px;line-height:44px;letter-spacing: 0.83px;font-size:16px;text-align:center;cursor:pointer;color:#FFFFFF;background:#1F8CEB;\" onclick=\"inv.talk()\" >在线咨询</div></div></div>";
		var is_autoyqk				= "1";
	...
	//	var acc_poptype				= -1;
		...
		var pc_ivt_top = "40";
		var pc_ivt_left = "50";
		var callback_id6ds = "10185234,10185236,10185237,10188796,10320689,10327074,10368267";
		...
		if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			...
			Inv.prototype = {
				...
				talk : function(){
					...
					if (zdfq_type == 3) {
						...
						var openurl = "https://www5c1.53kf.com/webCompany.php?kf_sign=jYyNDMTU4MY0NzExMjQ2MjE3MDkwMDAyNzIxMzI4Njk=&arg=10132869&style=1&kflist=off&kf=001%2C004%2C003%2C005%2Clexiwed_007%40163.com%2C3475870%40qq.com%2C2657853251%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fm.mijwed.com%2Fsem-sem20191112&keyword=&brief=&logo=&question=&uid=266f6068a297a9240f9d7e10540181d3&tfrom=2" + force_kf;
						onliner_zdfq=2;
			...
			if(1 == 1){
				btn_style1 = 'background: center center no-repeat;background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/png/img-info24.png);background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/svg/img-info24.svg), none;'
				btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/png/img-info36.png);background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/svg/img-info36.svg), none;'
			}else {
				btn_style1 = 'background: center center no-repeat;background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/png/img-email24.png);background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/svg/img-email24.svg), none;'
				btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/png/img-email36.png);background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/svg/img-email36.svg), none;'
			}
			...
			if(mini_style_type==1){
				bubble_html = '<div class="mini-btn mini-btn1" id="mini-btn" onclick="show_floatWindow();" style="width:auto;white-space:nowrap;cursor:pointer;'+mini_btn_display+'position:absolute;'+mini_button_position+'z-index:-1;height: 42px;border-radius:2px; overflow: hidden; background: '+minicolor_tbbj+';-webkit-box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;">'+
									...
									'<div class="mini-btn-window" style="display:inline-block;width: 42px;height: 42px;background: center center no-repeat;background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/png/to-maxWindow.png);background-image: url(https://www5c1.53kf.com/style/chat/new2017/image/svg/to-maxWindow.svg), none;"></div>'+
								'</div>';
			...
			tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
								'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 10px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
									'<img style="max-width: 80px;width:auto;height:24px;float: left;margin-top: 6px;border-radius:2px;" src="https://www5c1.53kf.com/img/upload/10132869/mobile/mobile_53kf_1497581873.jpg"/>'+
	...
	function show_floatWindow(type){//type:  zdfq:主动发起规则打开  qzzk:强制展开打开   不传:用户点击展开
		...
		try{
			...
			if (navigator.userAgent.indexOf("Firefox") > -1){
				document.getElementById('iframe_company_mini').contentWindow.postMessage('openMini',"https://www5c1.53kf.com/webCompany.php?kf_sign=jYyNDMTU4MY0NzExMjQ2MjE3MDkwMDAyNzIxMzI4Njk=&arg=10132869&style=1&kflist=off&kf=001%2C004%2C003%2C005%2Clexiwed_007%40163.com%2C3475870%40qq.com%2C2657853251%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fm.mijwed.com%2Fsem-sem20191112&keyword=&brief=&logo=&question=&uid=266f6068a297a9240f9d7e10540181d3&tfrom=2");
			}
	...
	function cgpic(t){
		if( $53("div_company_mini").style.width =="400px"){
			document.querySelector('.mini_narrow').style.background="url('https://www5c1.53kf.com/style/chat/minichat2/img/minx1.png') no-repeat";
		}

	}
	function cgpic2(t){
		if( $53("div_company_mini").style.width =="400px"){
			document.querySelector('.mini_narrow').style.background="url('https://www5c1.53kf.com/style/chat/minichat2/img/minx2.png') no-repeat";
		}
	}
	function cgpic3(t){
		document.querySelector('.mini_maxto').style.background="url('https://www5c1.53kf.com/style/chat/minichat2/img/double1.png') no-repeat";
	}
	function cgpic4(t){
		document.querySelector('.mini_maxto').style.background="url('https://www5c1.53kf.com/style/chat/minichat2/img/double2.png') no-repeat";
	}
	function cgpic5(t){
		document.querySelector('.mini_close').style.background="url('https://www5c1.53kf.com/style/chat/minichat2/img/close1.png') no-repeat 50% 50%";
	}
	function cgpic6(t){
		document.querySelector('.mini_close').style.background="url('https://www5c1.53kf.com/style/chat/minichat2/img/close2.png') no-repeat 50% 50%";
	}
	...
	function max_min_company_mini(t)
	{
		if (t.getAttribute('max_min') == 'max')
		{
			...
			t.style.backgroundImage = "url('https://www5c1.53kf.com/style/chat/minichat2/img/max.png')";
			t.setAttribute('max_min','min');
			t.title = t.getAttribute('mini_recover');
			$53("div_company_mini").style.right = '0px';
			$53("div_company_mini").style.bottom = '0px';			$53("mini_header_bg_div").style.backgroundImage = "url('https://www5c1.53kf.com/style/chat/minichat2/img/header_bg2_4.png')";
		}
		else
		{
			...
			t.style.backgroundImage = "url('https://www5c1.53kf.com/style/chat/minichat2/img/min.png')";
		...
		}		$53("mini_header_bg_div").style.backgroundImage = "url('https://www5c1.53kf.com/style/chat/minichat2/img/header_bg_4.png')";
	}
	// 定时调用判断是否显示邀请框
	...
	{
		if(zdfq_switch == 'yes') {
			//document.cookie = "onliner_zdfq72132869="+onliner_zdfq;
			document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
		} else {
			document.cookie = "my_acc_reauto_time=null;path=/";
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		try{
			...
			if(type==1){
				...
				if (open_mini_windown == '1' && "jh" == 'www111'){//品房阁需求 处理
					if (force_kf != '') {
						...
						if (workerid != '') {
							...
							try{
								document.getElementById('iframe_company_mini').contentWindow.postMessage(lnk_msg,"https://www5c1.53kf.com/webCompany.php?kf_sign=jYyNDMTU4MY0NzExMjQ2MjE3MDkwMDAyNzIxMzI4Njk=&arg=10132869&style=1&kflist=off&kf=001%2C004%2C003%2C005%2Clexiwed_007%40163.com%2C3475870%40qq.com%2C2657853251%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fm.mijwed.com%2Fsem-sem20191112&keyword=&brief=&logo=&question=&uid=266f6068a297a9240f9d7e10540181d3&tfrom=2");
							}catch(e){}
						}
					}
					return;
				...
				if('1' == 0){
					...
					$53("iframe_company_mini").src = openurl_mini + tpl + '&timeStamp=' + new Date().getTime()+'&interface_color=4&interface_theme=4&minchat_style=1';
	...
	function close_company_mini(){
		...
		// if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72132869="+onliner_zdfq;}
	...
	function ivt_seturl(zdy_yqk)
	{
		var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
			...
			if(vals[1])
			{
				...
				{
					case 'KF':
						var click_open_url = 'window.open(\"https://www5c1.53kf.com/webCompany.php?kf_sign=jYyNDMTU4MY0NzExMjQ2MjE3MDkwMDAyNzIxMzI4Njk=&arg=10132869&style=1&kflist=off&kf=001%2C004%2C003%2C005%2Clexiwed_007%40163.com%2C3475870%40qq.com%2C2657853251%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fm.mijwed.com%2Fsem-sem20191112&keyword=&brief=&logo=&question=&uid=266f6068a297a9240f9d7e10540181d3&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
						...
						break;
						//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www5c1.53kf.com/webCompany.php?kf_sign=jYyNDMTU4MY0NzExMjQ2MjE3MDkwMDAyNzIxMzI4Njk=&arg=10132869&style=1&kflist=off&kf=001%2C004%2C003%2C005%2Clexiwed_007%40163.com%2C3475870%40qq.com%2C2657853251%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=https%3A%2F%2Fm.mijwed.com%2Fsem-sem20191112&keyword=&brief=&logo=&question=&uid=266f6068a297a9240f9d7e10540181d3&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
					case 'CLOSE':
						click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
					case 'ETEL':
						click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72132869&style_id=106177136\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
					case 'QQ':
						if(valst[1]){
							if(valst[1].toLowerCase().indexOf('biz') > -1){
								var qq = valst[1].replace('biz','');
								link_str = 'https://www5c1.53kf.com/bizqq.php?qq=' + qq + '&from=' + window.encodeURIComponent(window.location.href);
							}else{
